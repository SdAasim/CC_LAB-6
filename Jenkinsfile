pipeline {
    ...
    stages {
        stage('Build Backend Image') {
            steps {
                ...
                # Accesses the backend folder inside the CC_LAB-6 directory
        ...
        stage('Deploy NGINX Load Balancer') {
            steps {
                ...
                # Copies the config from the nested nginx folder
    ...
    post {
        ...
        failure { echo 'Pipeline failed. Check paths or network logs.' }
    }
}
